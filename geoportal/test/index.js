...
// Defini variable para visualizaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n del MAPA Bounding box 
...
// CAPA BASE - BASELAYERS
		...
		var Tematicos = new OpenLayers.Layer.WMS("INAB-Sistemas de Informacion Forestal",
			"http://186.151.231.162:8080/geoserver/dinamica_forestal/wms", {
				layers: [
					"Dinamica Forestal 2001-2006",
					"Dinamica Forestal 2006-2010",
					"Cobertura Forestal por Tipo 2012",
					"Restauracion del Paisaje",
					"PPM en Plantaciones",
					"PPM en Bosque Natural",
					"Pinfor Certificados",
					"PINPEP Certificados",
					"PINPEP",
					"PINFOR"
...
/*****************BEGIN TOOLBAR************/
		  var createTbarItems = function(map) {
				...
				var Control_Poligonal=new OpenLayers.Control.Measure(OpenLayers.Handler.Polygon,{eventListeners:{measure:function(event){Ext.Msg.alert("Area",event.measure.toFixed(3)+" "+event.units+"ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â²");}},persist:true,geodesic:true});
				actions.push(new GeoExt.Action({
					//text: "  ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Ârea",
					tooltip:'Medir Area',
					iconCls:'medirarea',
...
// FunciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n GetFeatrueInfo Popup
				var info = new OpenLayers.Control.WMSGetFeatureInfo({
					url: 'http://186.151.231.162:8080/geoserver/dinamica_forestal/wms', 
...
// ---- FUNCION QUE DESPLIEGA LOS SHAPES EN EL PANE CENTRAL MAPA ----
		mapPanel = new GeoExt.MapPanel({
			...
			margins: "5 5 5 5",
			split: true,
			layers: [osm, ghyb, gpte, gphy, Tematicos, Departamentos, Cartobasica],
...
//	------------------------------INICIO FUNCIÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œN DE PRUEBA --------------------------------------------	
  // create our own layer node UI class, using the TreeNodeUIEventMixin
	...
	{
		nodeType: "gx_layer",
		layer: "INAB-Sistemas de Informacion Forestal",
		isLeaf: false,
		checked: false,
		expanded: true,		
		loader: {
...
// FUNCIÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œN QUE CREA el Viwport en donde estarÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ hospedado el LayerTree y legendPanel

		new Ext.Viewport({
        layout: "border",
		hideBorders: true,
        items: [{		// DefiniciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n region Norte Superior de visor, el banner de la pÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡gina
            region: "north",
            contentEl: "title", //hacer referencia al contenido de la variable TITLE
            height: 140 //define alto del banner
			},  
			mapPanel, 
			{
				region: "west",
