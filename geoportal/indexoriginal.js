...
// CAPA BASE - BASELAYERS
		...
		var mangle = new OpenLayers.Layer.WMS("MARN-WMS Estudio Cobertura Mangle 2012",
			"http://geoportal.marn.gob.gt:8080/geoserver/MANGLE2012/wms", {
				layers: [
					"Mangle Atlantico",
					"Mangle Pacifico"
				],
		...
		var reddp = new OpenLayers.Layer.WMS("MARN-WMS Sub Regiones Nacionales",
			"http://geoportal.marn.gob.gt:8080/geoserver/REDDplus/wms", {
				layers: [
					"Subregiones Nacionales",
				],
				transparent: true,
				checked: false,				
			}, {
		...
		var marn = new OpenLayers.Layer.WMS("MARN-WMS Delegaciones MARN",
			"http://geoportal.marn.gob.gt:8080/geoserver/Delegaciones/wms?service=WMS", {
				layers: [
					"DELEGACIONES",					
				],
				transparent: true,
		...
		var inab = new OpenLayers.Layer.WMS("INAB-WMS Dinamica Forestal",
		...
		var conap= new OpenLayers.Layer.WMS("CONAP-WMS Mapas Tematicos",
			"http://www.bchguatemala.gob.gt:8081/geoserver/conap/wms", {
				layers: [
				     "Vacios de Conservacion",
					 "Direcciones Regionales",
					 "Areas Protegidas 2015"
				],
				transparent: true,
				checked: false,
			}, {
...
// Funcion GetFeatrueInfo Popup
				var info = new OpenLayers.Control.WMSGetFeatureInfo({
					//url: 'http://geoportal.marn.gob.gt:8080/geoserver/MANGLE2012/wms', 
...
// ---- FUNCION QUE DESPLIEGA LOS SHAPES EN EL PANE CENTRAL MAPA ----
		mapPanel = new GeoExt.MapPanel({
			...
			margins: "2 2 2 2",
			split: true,
			layers: [osm, gphy, ghyb, gpte, mangle, reddp, Departamentos, Cartobasica, inab, conap, marn],
...
//	------------------------------INICIO FUNCION CREACION DE ESTRUCTURA DE CARPETAS PADRE E HIJO --------------------------------------------	
  // CREA LA CAPA DEL NODO UI, USANDO TreeNodeUIEventMixin
	...
	{
		nodeType: "gx_layer",
		layer: "MARN-WMS Estudio Cobertura Mangle 2012",
		isLeaf: false,
		checked: false,
		expanded: true,		
		loader: {
	...
	{
        nodeType: "gx_layer",
        layer:"MARN-wms Sub Regiones Nacionales",
 		isLeaf: false,
		checked: false,
		expanded: true,		
		loader: {
	...
	{
        nodeType: "gx_layer",
        layer: "MARN-WMS Delegaciones MARN",
        checked: false,
		isLeaf: false,		
		expanded: true,
        loader: {
	...
	{
        nodeType: "gx_layer",
        layer: "INAB-WMS Dinamica Forestal",
        checked: false,
		isLeaf: false,		
		expanded: true,
        loader: {
	...
	{
        nodeType: "gx_layer",
        layer: "CONAP-WMS Mapas Tematicos",
        checked: false,
		isLeaf: false,		
		expanded: true,
        loader: {
